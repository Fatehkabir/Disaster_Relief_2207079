...
@php try { $criticalCount = \App\Models\Incident::where('severity','critical')->active()->count(); } catch(\Exception $e) { $criticalCount = 0; } @endphp
@if($criticalCount > 0)
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navMain">
            ...
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item">
                    <form action="{{ route('logout') }}" method="POST" class="d-inline">
                        @csrf
                        <button class="btn btn-sm btn-outline-secondary" style="border-color:#0891b2; color:#0891b2;">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="btn btn-sm fw-bold" href="{{ route('register') }}" style="background:#06b6d4; color:#fff;">Join Now</a>
                </li>
            </ul>
            @endguest
        </div>
...
<div class="container mt-3">
    <div class="alert alert-success alert-dismissible fade show border-0 shadow-sm" role="alert"
         style="background: linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%); color: #065f46; border-left: 4px solid #10b981;">
...
<div class="container mt-3">
    <div class="alert alert-danger alert-dismissible fade show border-0 shadow-sm" role="alert"
         style="background: linear-gradient(135deg, #fee2e2 0%, #fecaca 100%); color: #7f1d1d; border-left: 4px solid #f97316;">
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-md-5">
                ...
                <p class="small mb-1"><i class="bi bi-telephone-fill me-2" style="color: #a5f3fc;"></i> Emergency Hotline: <strong class="text-white">999</strong></p>
                <p class="small mb-1"><i class="bi bi-telephone-fill me-2" style="color: #a5f3fc;"></i> Fire Service: <strong class="text-white">199</strong></p>
                <p class="small mb-1"><i class="bi bi-telephone-fill me-2" style="color: #a5f3fc;"></i> Ambulance: <strong class="text-white">199</strong></p>
